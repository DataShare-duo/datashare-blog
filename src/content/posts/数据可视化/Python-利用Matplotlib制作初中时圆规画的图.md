---
title: Python 利用Matplotlib制作初中时圆规画的图
slug: 数据可视化/Python-利用Matplotlib制作初中时圆规画的图
published: 2023-08-29
description: Python Matplotlib规画的图
image: /python.jpg
showCoverInPost: false
tags: [python, 工具, matplotlib]
...
# 历史相关文章
- [利用Python画出《人民日报》各国疫情图——南丁格尔玫瑰图](../../数据可视化/利用Python画出《人民日报》各国疫情图——南丁格尔玫瑰图/)
- [Matplotlib 自定义函数实现左边柱形图，右边饼图](../../数据可视化/Matplotlib-自定义函数实现左边柱形图，右边饼图/)
- [Python 利用4行代码实现图片灰度化](../../Python图像处理/Python-利用4行代码实现图片灰度化/)
